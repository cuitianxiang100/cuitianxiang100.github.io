---
layout:     post
title:      "Python笔记day42（MySQL）|数据库操作、数据表操作、表内容操作、数据类型"
subtitle:   "数据库操作、数据表操作、表内容操作、数据类型"
...
> 数据库操作、数据表操作、表内容操作、数据类型 | 若本文不能正常显示 [点击这里](https://blog.csdn.net/qq_34755081/article/details/82251861)
#### 1，数据库操作
...
```
delete from 表名
truncate table 表名 #使用此方法清空后，自增id从1开始
```
