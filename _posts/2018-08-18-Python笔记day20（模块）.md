---
layout:     post
title:      "Python笔记day20（模块）|序列化模块、json、pickle、shelve"
subtitle:   "序列化模块、json、pickle、shelve"
date:       2018-08-18 20:11:00
author:     "崔天祥"
...
> 序列化模块、json、pickle、shelve | 若本文不能正常显示 [点击这里](https://blog.csdn.net/qq_34755081/article/details/81812551)
#### 1，模块
